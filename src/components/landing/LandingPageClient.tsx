...
const steps = [
  { num: '01', title: 'Sign in free', desc: 'Create a free account with email and password.' },
  ...
  return (
    <div className="min-h-screen" style={{ background: '#faf7f2' }}>
      ...
      <section className="py-16 px-6 border-t border-[#e8ddd0]" style={{ background: 'white' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Next.js 16', 'TypeScript', 'MongoDB Atlas', 'Gemini 2.0 Flash', 'Flux Schnell', 'Framer Motion', 'NextAuth.js', 'scikit-learn'].map((tech) => (
      ...
      <footer className="py-8 px-6 text-center text-sm text-[#718096] border-t border-[#e8ddd0]">
        ...
        <p className="mb-2">Built with ❤️ using Next.js, Gemini AI & MongoDB Atlas</p>
